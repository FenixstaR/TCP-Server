...
function RSACipherMessageToBuf(const KeySize: Integer; const CipherMessage: TRSAMessage; var CipherBuf; const CipherBufSize: Integer): Integer;

function RSAEncrypt(const EncryptionType: TRSAEncryptionType; const PrivateKey: TRSAPrivateKey; const PlainBuf; const PlainBufSize: Integer; var CipherBuf; const CipherBufSize: Integer): Integer;
function RSAEncrypt_PbK(const EncryptionType: TRSAEncryptionType; const PublicKey: TRSAPublicKey; const PlainBuf; const PlainBufSize: Integer; var CipherBuf; const CipherBufSize: Integer): Integer;
...
function RSAEncryptStr(const EncryptionType: TRSAEncryptionType; const PrivateKey: TRSAPrivateKey; const Plain: String): String;
...
procedure RSADecryptMessage_PrK(const Key: TRSAPrivateKey; const CipherMessage: TRSAMessage; var EncodedMessage: TRSAMessage);overload;
procedure RSADecryptMessage(const Key: TRSAPublicKey; const CipherMessage: TRSAMessage; var EncodedMessage: TRSAMessage);overload;
...
function RSADecrypt_PrK(const EncryptionType: TRSAEncryptionType; const Key: TRSAPrivateKey; const CipherBuf; const CipherBufSize: Integer; var PlainBuf; const PlainBufSize: Integer): Integer;
function RSADecrypt(const EncryptionType: TRSAEncryptionType; const Key: TRSAPublicKey; const CipherBuf; const CipherBufSize: Integer; var PlainBuf; const PlainBufSize: Integer): Integer;
...
function RSADecryptStr(const EncryptionType: TRSAEncryptionType; const PublicKey: TRSAPublicKey; const Cipher: String): String;
  ...
  try
    repeat
      repeat
        ...
        N := Byte(HugeWordGetElement(P, C - 1) shr (HugeWordElementBits - 8)) * Byte(HugeWordGetElement(Q, C - 1) shr (HugeWordElementBits - 8));
      until N >= $0100;
      // ensure prime
...
begin
  ...
  try
    ...
    HugeWordAssign(PublicKey.Exponent, PrivateKey.PublicExponent);
  finally
  end;
end;
...
procedure RSADecryptMessage_PrK(const Key: TRSAPrivateKey; const CipherMessage: TRSAMessage; var EncodedMessage: TRSAMessage);
begin
  // validate
  if (Key.KeySize <= 0) or (Key.KeySize mod HugeWordElementBits <> 0) then
    raise ERSA.Create(SRSAInvalidKeySize);
